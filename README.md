...
4. Run `npm start` to start the application and auto launch your browser with the application running on localhost:3000.

**Information about the back end server from the forked repo via Udacity is left below**
